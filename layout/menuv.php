				<div class="sidebar fondo borde fuenteAzul sombra vertical" >
					...
					<ul class="menuv">
						<li class="list-unstyled icoMedia">
							<a href="#" id="linkPanel"><i class="fas fa-home"></i> 
							<label class="modulo">	Inicio</label></a>
						</li>
						<li class="list-unstyled icoMedia">
							<a href="#" id="linkMisDatos"><i class="fas fa-user-circle"></i> 
							<label class="modulo">	Mis Datos</label></a>
						</li>
						<li class="list-unstyled icoMedia">
						...
						<li class="list-unstyled icoMedia">
							<a href="#" id="linkMiContra"><i class="fas fa-unlock-alt"></i> 
							<label class="modulo">	Cambiar Contraseña</label></a></a>
						</li>
